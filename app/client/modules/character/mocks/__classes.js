        ...
        "spells": [
            {
                "level": 1,
                "name": "Expose Armor",
                "description": "Attack doing no DMG but reducing the physical armor of the target by $(2+lvl)$ for all enemies attacking that target. Does not work against magical armor like a mage aura or a stone skin. Does not naturally stack. Costs 3 AP"
            },
            {
                "level": 2,
                "name": "Vanish",
                "description": "Hide by walking into the Shadow Realm and emerge hidden. You step through the Shadow Realm and emerge $(AGI+lvl)meters$ in max lvl Initiative points. This means that the higher level you are, the longer you can stay hidden in the Shadow Realm. You emerge hidden. Cost 5 AP, cannot attack or do other things whilst hidden. 0 INI but a cooldown of 1000 INI."
            },
            {
                "level": 3,
                "name": "Interrupt",
                "description": "The offensive action the target was about to do gets a $(10+lvl)INI$, cost 3 AP. If the action was a spell the target must make an INU check with a $-10$ to see if the spell is interrupted."
            },
            {
                "level": 4,
                "name": "Recuperate",
                "description": "Drain AP from the target and give yourself a fraction of these AP with per 10 IP as a bonus. Each AP you spend leaches 1 AP from the target with a max $(2∗lvl+2)$. Needs a successful hit and must be called in advance. At level 3, while your recuperate is active every action costs 1AP less."
            },
            {
                "level": 5,
                "name": "Ignore Armor",
