export default {
    ...
    "spells": [
        ...
        },
        {
            ...
            "description": "Instantly allow a party member to take an action. Off global Cool Down. Has <%= 80 - (5 * rank)  %> INI CD. All Power Words share the same Power Word Cool Down."
        },
        {
            "rank": 1,
            "title": "Power Word Fear",
        ...
        },
        {
            ...
            "description": "Reduce the next attack the target taked to <%= rank %>d10 dmg both magical or physical."
        },
        {
            "rank": 1,
            "title": "True Sight",
